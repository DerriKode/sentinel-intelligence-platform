...
| D-020 | The public shell remains separate under `/public/*`, exposes only approved public navigation and safe display-ready state, and enables a language only after reviewed translation is available | `STAGE_2_PUBLIC_PORTAL_SHELL.md`, `apps/web/src/components/public-shell/` | Implemented; approval pending |
