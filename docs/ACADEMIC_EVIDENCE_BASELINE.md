...
|---|---|---|
| Objectives and problem framing | `STAGE_0_ACADEMIC_REPORT_REVIEW.md` | Recorded |
| Actors, scope, and critical workflows | `STAGE_0_SCOPE_AND_STAKEHOLDERS.md` | Recorded |
| Functional and role acceptance | `REQUIREMENTS_FUNCTIONAL_AND_ACCEPTANCE.md` | Recorded |
| Measurable quality expectations | `NON_FUNCTIONAL_REQUIREMENTS_AND_BUDGETS.md` | Provisional targets recorded |
| Architecture and data rationale | `ARCHITECTURE_AND_MODULE_BOUNDARIES.md`, `DATA_MODEL_AND_DATA_GOVERNANCE.md` | Recorded |
| Security, privacy, and AI limitations | `SECURITY_ROLE_AND_AI_GOVERNANCE.md`, `RISK_REGISTER.md` | Recorded |
